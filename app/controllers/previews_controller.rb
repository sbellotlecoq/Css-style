class PreviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @preview.save
        format.html { redirect_to preview_url(@preview), notice: "Preview was successfully created." }
  ...
  def update
    respond_to do |format|
      if @preview.update(preview_params)
        format.html { redirect_to preview_url(@preview), notice: "Preview was successfully updated." }
